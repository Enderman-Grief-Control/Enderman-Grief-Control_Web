...
export const modrinth: PlatformLink = {
  ...
  description: 'One listing with both the Fabric mod and the Paper plugin builds.',
...
export const distributions: PlatformLink[] = [modrinth, curseforgeFabric, curseforgePaper];

export const dashboardHref = 'https://enderman-grief-control.onrender.com/dashboard';
